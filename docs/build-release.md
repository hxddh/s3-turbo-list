...
```
dist/
├── s3-turbo-list-0.1.0-linux-x86_64
├── s3-turbo-list-0.1.0-linux-x86_64.sha256
├── s3-turbo-list-0.1.0-linux-arm64
└── s3-turbo-list-0.1.0-linux-arm64.sha256
```
...
```bash
./dist/s3-turbo-list-0.1.0-linux-arm64 --version
./dist/s3-turbo-list-0.1.0-linux-arm64 --help
```
