...
```
dist/
├── s3-turbo-list-0.2.1-linux-x86_64
├── s3-turbo-list-0.2.1-linux-x86_64.sha256
├── s3-turbo-list-0.2.1-linux-aarch64
└── s3-turbo-list-0.2.1-linux-aarch64.sha256
```
...
```bash
./dist/s3-turbo-list-0.2.1-linux-aarch64 --version
./dist/s3-turbo-list-0.2.1-linux-aarch64 --help
```
