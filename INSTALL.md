...
| Platform | Binary |
|---|---|
| Linux x86_64 | `s3-turbo-list-0.1.19-linux-x86_64` |
| Linux ARM64 / aarch64 | `s3-turbo-list-0.1.19-linux-aarch64` |
| macOS Apple Silicon | `s3-turbo-list-0.1.19-macos-aarch64` |
| macOS Intel | `s3-turbo-list-0.1.19-macos-x86_64` |
...
```bash
chmod +x s3-turbo-list-0.1.19-linux-x86_64
sudo install -m 0755 s3-turbo-list-0.1.19-linux-x86_64 /usr/local/bin/s3-turbo-list
...
```bash
chmod +x s3-turbo-list-0.1.19-linux-aarch64
sudo install -m 0755 s3-turbo-list-0.1.19-linux-aarch64 /usr/local/bin/s3-turbo-list
s3-turbo-list --version
```
...
```bash
chmod +x s3-turbo-list-0.1.19-macos-aarch64
xattr -d com.apple.quarantine ./s3-turbo-list-0.1.19-macos-aarch64 2>/dev/null || true
sudo install -m 0755 s3-turbo-list-0.1.19-macos-aarch64 /usr/local/bin/s3-turbo-list
s3-turbo-list --version
```
...
```bash
chmod +x s3-turbo-list-0.1.19-macos-x86_64
xattr -d com.apple.quarantine ./s3-turbo-list-0.1.19-macos-x86_64 2>/dev/null || true
sudo install -m 0755 s3-turbo-list-0.1.19-macos-x86_64 /usr/local/bin/s3-turbo-list
s3-turbo-list --version
```
